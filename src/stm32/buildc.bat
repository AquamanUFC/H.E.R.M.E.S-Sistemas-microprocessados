...
arm-none-eabi-gcc -Llib/src -Ilib/inc -Ilib -ggdb -fno-builtin-free -fno-builtin-memset -mcpu=cortex-m3 -mthumb -c -o2 -Wall lib/config.c -o lib/obj/config.o  2>> log/main.log


arm-none-eabi-as -mcpu=cortex-m3 -o lib/obj/m0s.o core/cm0.asm 2>>log/main.log

arm-none-eabi-ld -Ttext 0x8003000 -Tdata 0x800A000 -Tbss 0x20000000 lib/obj/m0s.o lib/obj/stm32f10x_usart.o lib/obj/stm32f10x_rcc.o lib/obj/stm32f10x_gpio.o lib/obj/misc.o lib/obj/demo.o lib/obj/config.o -o output/m0s.elf 2>>log/main.log
